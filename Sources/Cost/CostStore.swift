    ...
    private func loadDemoData() {
        ...
        self.claude = ProviderCost(
            today: CostWindow(
                ...
                label: "今日", error: nil, unknownModels: []
            ),
            month: CostWindow(
                ...
                label: "4月", error: nil, unknownModels: []
            )
        )
    ...
    private func restoreFromCache() {
        ...
        self.claude = ProviderCost(
            today: CostWindow(dollars: snap.claudeToday, tokens: snap.claudeTodayTokens,
                              ...
                              series: snap.claudeTodaySeries, label: "今日", error: nil,
        ...
        self.codex = ProviderCost(
            today: CostWindow(dollars: snap.codexToday, tokens: snap.codexTodayTokens,
                              ...
                              series: snap.codexTodaySeries, label: "今日", error: nil,
