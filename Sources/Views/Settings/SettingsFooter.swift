...
/// Bottom footer for the Settings window. Internal repo / license as dotted-
/// underline links, Quit pill flush right. Version lives in the brand
/// header at the top of the window.
struct SettingsFooter: View {
    @State private var quitHovered = false

    private static let repoURL = URL(string: "https://github.com/daodaolee/super-agent-island")!
    private static let licenseURL = URL(string: "https://github.com/daodaolee/super-agent-island/blob/main/LICENSE")!

    var body: some View {
        HStack(alignment: .center, spacing: 14) {
            link("GitHub", url: Self.repoURL)
            link("许可证", url: Self.licenseURL)
